                                                ...
                                                <div class="field-item mb-2 p-3 bg-gray-50 dark:bg-white/5 rounded-lg border border-gray-200 dark:border-white/10 cursor-move" data-field-id="<?php echo esc_attr($field['id']); ?>">
                                                    <div class="flex items-center gap-2 sm:gap-3">
                                                        ...
                                                        <div class="flex-1 min-w-0">
                                                            <p class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white truncate"><?php echo esc_html($field['label']); ?></p>
                                                            <p class="text-xs text-gray-500 dark:text-gray-400"><?php echo esc_html($fieldTypes[$field['type']]['label'] ?? $field['type']); ?> <?php echo $field['required'] ? '• Zorunlu' : ''; ?></p>
                                                        </div>
    ...
    <script>
        ...
        const FormBuilder = {
                    ...
                    <div class="field-item mb-2 p-3 bg-gray-50 dark:bg-white/5 rounded-lg border border-gray-200 dark:border-white/10 cursor-move" data-field-id="${field.id}">
                        <div class="flex items-center gap-2 sm:gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">${this.fieldTypes[field.type]?.label || field.type} ${field.required ? '• Zorunlu' : ''}</p>
                            </div>
                            <div class="flex items-center gap-1 flex-shrink-0">
            ...
            showFieldEditor(field) {
                ...
                content.querySelector('#edit-required').checked = field.required == 1;
            ...
            updateFieldInList(field) {
                ...
                if (fieldItem) {
                    fieldItem.querySelector('.field-label').textContent = field.label;
                    const subText = fieldItem.querySelector('.text-xs');
                    subText.textContent = `${this.fieldTypes[field.type]?.label || field.type} ${field.required ? '• Zorunlu' : ''}`;
                }
