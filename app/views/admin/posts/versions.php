...
<?php
// Controller'dan gelen değişkenler: $user, $post, $versions, $message, $messageType
$versions = $versions ?? [];
?>
        ...
        <main class="main-content-with-sidebar flex-1 p-6 lg:p-10 lg:ml-64 bg-gray-50 dark:bg-[#15202b]">
            <div class="layout-content-container flex flex-col w-full mx-auto max-w-5xl">
                ...
                <header class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                    <div class="flex flex-col gap-2">
                        <div class="flex items-center gap-2">
                            <a href="<?php echo admin_url('posts/edit/' . $post['id']); ?>" class="text-gray-500 hover:text-primary transition-colors">
                        ...
                        <p class="text-gray-500 dark:text-gray-400 text-base">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-primary/10 text-primary ml-2">
                                Mevcut: v<?php echo esc_html($post['version'] ?? 1); ?>
                            </span>
                        </p>
                    </div>
                    <div class="flex items-center gap-2">
                        <a href="<?php echo admin_url('posts/edit/' . $post['id']); ?>" class="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors">
                            <span class="material-symbols-outlined text-xl">edit</span>
                            <span class="text-sm font-medium">Yazıya Dön</span>
                        </a>
                    </div>
                </header>
                ...
                <div class="rounded-xl border-2 border-primary/30 bg-primary/5 dark:bg-primary/10 p-6 mb-6">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Mevcut Versiyon (v<?php echo esc_html($post['version'] ?? 1); ?>)</h3>
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    Son güncelleme: <?php echo date('d.m.Y H:i', strtotime($post['updated_at'])); ?>
                                </p>
                            </div>
                        </div>
                ...
                <div class="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-800 p-12 text-center">
                    ...
                    <p class="text-gray-500 dark:text-gray-400">Bu yazı güncellendiğinde önceki versiyonlar burada görünecek.</p>
                </div>
                <?php else: ?>
                <div class="space-y-4">
                    ...
                    <div class="rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-gray-800 overflow-hidden">
                        <div class="p-4 flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <a href="<?php echo admin_url('posts/restore-version/' . $version['id']); ?>" 
