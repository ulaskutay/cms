    ...
    createModal() {
        ...
        const modalHTML = `
            <div id="media-picker-modal" class="fixed inset-0 z-[99999] hidden">
                ...
                <div class="absolute inset-4 md:inset-8 lg:inset-12 bg-white dark:bg-background-dark rounded-2xl shadow-2xl overflow-hidden flex flex-col">
                    <!-- Header -->
                    ...
                    <!-- Footer -->
                    <div class="flex items-center justify-between px-6 py-4 border-t border-gray-200 dark:border-white/10 bg-gray-50 dark:bg-white/5">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="button" id="media-picker-select-btn" onclick="window.mediaPicker?.confirmSelection()" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed" disabled>
                                Seç
                            </button>
                        </div>
                    </div>
