...
(function() {
     ...
     * Not: Dark mode zaten head'deki inline script tarafından uygulanmış olmalı
     * Bu fonksiyon sadece icon'ları günceller ve event listener'ları ekler
     */
    function initDarkMode() {
        // Dark mode zaten head'deki script tarafından uygulanmış
        // Toggle switch'i başlangıç durumuna göre ayarla
        const currentMode = isDarkMode();
